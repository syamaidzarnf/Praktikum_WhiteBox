...
//Anotasi untuk menyediakan data parameterized test dari sumber CSV
    ...
    @Test
    @DisplayName("toString menampilkan semua atribut produk")
    void testToString() {
        Produk produk = new Produk("P01", "Laptop", "Elektronik", 5000000, 10, 2);
        String hasil = produk.toString();

        assertTrue(hasil.contains("P01"));
        assertTrue(hasil.contains("Laptop"));
        assertTrue(hasil.contains("Elektronik"));
        assertTrue(hasil.contains("5000000"));
    }
